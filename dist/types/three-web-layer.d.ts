...
export default class WebLayer3D extends THREE.Object3D {
    ...
    parentLayer: WebLayer3D | undefined;
    private _level;
    ...
    static UPDATE_DEFAULT: (layer: WebLayer3D, deltaTime?: number) => void;
    ...
    constructor(element: Element, options?: WebLayer3DOptions, parentLayer?: WebLayer3D | undefined, _level?: number);
    /**
    ...
    get layersByElement(): WeakMap<Element, WebLayer3D>;
    _normalizedBounds: {
        left: number;
        top: number;
        width: number;
